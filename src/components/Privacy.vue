<template>
  <div>
    <a v-b-modal.privacy>Privacy</a>
    <div>
      <b-modal id="privacy" scrollable title="Privacy">
        <div>
          <h1>Privacy Policy for PseudoAlgo</h1>
          <p>
          ...
          <p>
            ...
            by [YOUR SITE URL] and how we use it.
          </p>
          <p>
            <b>Log Files</b><br />
            Like many other Web sites, [YOUR SITE URL] makes use of log files.
          ...
          <p>
            <b>Cookies and Web Beacons</b><br />[YOUR SITE URL] uses cookies to
            store information about visitors' preferences, to record
            user-specific information on which pages the site visitor accesses
            or visits, and to personalize or customize our web page content
            based upon visitors' browser type or other information that the
          ...
          <p>
            <em
              ...
              of the advertising partners of [YOUR SITE URL].</em
            >
          </p>
          <p>
            These third-party ad servers or ad networks use technology in their
            respective advertisements and links that appear on [YOUR SITE URL]
          ...
          <p>
            [YOUR SITE URL] has no access to or control over these cookies that
          ...
          <p>
            ...
            certain practices. [YOUR SITE URL]'s privacy policy does not apply
            to, and we cannot control the activities of, such other advertisers
            or web sites. You may find a comprehensive listing of these privacy
          ...
          <p>
            <strong>Children's Information</strong><br />We believe it is
            ...
            online activity.<br />
            [YOUR SITE URL] does not knowingly collect any personally
            identifiable information from children under the age of 13. If a
            parent or guardian believes that [YOUR SITE URL] has in its database
            the personally-identifiable information of a child under the age of
          ...
          <p>
            <b>Update</b><br />This Privacy Policy was last updated on: Nov 1st,
